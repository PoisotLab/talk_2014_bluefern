...
\begin{frame}[b] % Conclusion
   \begin{beamercolorbox}[left, leftskip=.1\textwidth]{credits}
      \bfseries%
      network structure is predicted by\\\alert{simple evolutionary rules} \vskip 1em
      types of networks differ on their\\\alert{tendency to retain interactions}
   \end{beamercolorbox}
   \vskip .1\textwidth
\end{frame}
...
\begin{frame}[b] % Credits
   \begin{beamercolorbox}[left, leftskip=.1\textwidth]{credits}
      ...
      \textbf{Made with:} \LaTeX, pgfplots, tikz, a baby mashing on the keyboard\vskip 1em
